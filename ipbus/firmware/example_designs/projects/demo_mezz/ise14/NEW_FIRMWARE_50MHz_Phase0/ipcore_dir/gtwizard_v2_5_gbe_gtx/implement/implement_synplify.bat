...
COPY gtwizard_v2_5_gbe_gtx_exdes.edf .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\gtwizard_v2_5_gbe_gtx_exdes.ucf -p xc7k160t-fbg484-1 gtwizard_v2_5_gbe_gtx_exdes.edf gtwizard_v2_5_gbe_gtx_exdes.ngd
...
ECHO 'Running NGD'
map -p xc7k160t-fbg484-1 -o mapped.ncd gtwizard_v2_5_gbe_gtx_exdes.ngd
