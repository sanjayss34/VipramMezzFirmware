...
COPY gtwizard_v2_5_gbe_gtx_exdes.ngc .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\gtwizard_v2_5_gbe_gtx_exdes.ucf -p xc7k160t-fbg484-1 gtwizard_v2_5_gbe_gtx_exdes.ngc gtwizard_v2_5_gbe_gtx_exdes.ngd
...
ECHO 'Running NGD'
map -register_duplication on -logic_opt on -timing -ol high -p xc7k160t-fbg484-1 -o mapped.ncd gtwizard_v2_5_gbe_gtx_exdes.ngd
...
netgen -ofmt verilog -sim -sdf_path ../../implement/results -dir . -tm gtwizard_v2_5_gbe_gtx_exdes -w routed.ncd routed.v
